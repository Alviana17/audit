...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="{{ route('RKIA.index') }}" class="menu-link">
        <i class="menu-icon tf-icons bx bx-cube-alt"></i>
        <div data-i18n="Misc">RKIA</div>
      </a>
    </li>
    @if(auth()->user()->jabatan === 'General Manager')
      ...
      <li class="menu-item">
        <a href="{{ route('BA.index') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-cube-alt"></i>
          <div data-i18n="Misc">BAHAN KLARIFIKASI</div>
        </a>
      </li>
      <li class="menu-item">
      ...
      <li class="menu-item">
        <a href="{{ route('lhaf.index') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-cube-alt"></i>
          <div data-i18n="Misc">MONITORING</div>
        </a>
      </li>
      <!-- Signature -->
      <li class="menu-header small text-uppercase">
    ...
    <!-- KKA -->
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">KKA</span>
    </li>
    <li class="menu-item">
      <a href="{{ route('kkas.index') }}" class="menu-link">
        <i class="menu-icon tf-icons bx bx-cube-alt"></i>
