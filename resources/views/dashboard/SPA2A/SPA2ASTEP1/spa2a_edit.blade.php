                    ...
                    <div class="card-header">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('audits.index') }}">SP2A</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('audits.edit', $audit->id) }}">Edit SP2A</a></li>
                            </ol>
                        </nav>
                    </div>
