                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            ...
                            {{-- <a href="{{ route('audits.index') }}" class="btn btn-primary">Print Preview SP2A</a>
                            --}}
                        </div>
                    </div>
                    <!-- Detail SPA2A -->
                    ...
                    <div class="col-xl-12">
                        <div class="nav-align-top mb-4">
                            <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                                ...
                                <li class="nav-item">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                        data-bs-target="#navs-pills-preview" aria-controls="navs-pills-preview"
                                        aria-selected="false">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="navs-pills-preview" role="tabpanel">
                                    ...
                                    <div class="container">
                                        <a href="{{ route('audits.print', $audit->id) }}"
