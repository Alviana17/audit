...
use App\Http\Controllers\BahanKlarifikasiController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/audits/print/{id}', [AuditController::class, 'print'])->name('audits.print');
});
...
//  routes untuk bahan klarifikasi 
Route::middleware('auth')->group(function () {
    Route::get('/bahanklarifikasi', [BahanKlarifikasiController::class, 'index'])->name('BA.index');

});
//  routes untuk rkia 
Route::middleware('auth')->group(function () {
    Route::get('/rkia', [rkiaController::class, 'index'])->name('RKIA.index');
});
//  routes untuk 
Route::middleware('auth')->group(function () {
